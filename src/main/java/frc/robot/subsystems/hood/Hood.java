...
public class Hood extends SubsystemBase {
  ...
  public Hood() {
    ...
    hood_pid.enableContinuousInput(-max_angle, max_angle);
  ...
  public void moveToAngle(double angle) {
    ...
    manipulate(velocity/hood_rpm);
  }

  public boolean reachSetpoint() {
    return hood_pid.atSetpoint();
  }
  ...
  public void periodic() {
    ...
    moveToAngle(SmartDashboard.getNumber("Hood angle", 0));
